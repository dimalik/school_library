...
class Profile(UserenaLanguageBaseProfile):
    ...
    taksi = models.PositiveSmallIntegerField(choices=TMIMATA, blank=True, null=True, verbose_name=u'Τάξη')
    tmima = models.PositiveSmallIntegerField(blank=True, null=True, verbose_name=u'Τμήμα')
